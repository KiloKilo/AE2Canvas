...
var Stroke = require('../property/Stroke'),
    Path = require('./Path'),
    Rect = require('./Rect'),
    Ellipse = require('./Ellipse'),
    Polystar = require('./Polystar'),
    AnimatedPath = require('./AnimatedPath'),
    Fill = require('../property/Fill'),
    GradientFill = require('../property/GradientFill'),
    Transform = require('../transform/Transform'),
    Merge = require('../property/Merge'),
    Trim = require('../property/Trim');
