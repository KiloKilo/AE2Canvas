...
Group.prototype.draw = function (ctx, time, parentFill, parentStroke, parentTrim, isBuffer) {
    ...
    if (this.shapes) {
        if (this.merge) {
            ...
            for (i = 0; i < this.shapes.length; i++) {
                console.log('ctx', ctx.currentTransform, isBuffer);
